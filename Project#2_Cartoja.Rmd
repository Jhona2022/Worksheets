...
#Extract 10000 tweets from Twitter using twitteR package including retweets.Subset the retweets and the original tweets into a separate file Plot the retweets and the original tweets using bar graph in vertical manner. Include legends. Extract 10000 tweets from Twitter using twitteR package including retweets.
